...
public class PetProvider extends ContentProvider {
    //URI matcher code for the content URI for pets table
    ...
    static {
        ...
        //The content URI of the form content://.....pets/pets/3 will mapp to the integer code. This URI is used to provide
        //access to multiple rows at the pets table
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        //Figure out if the UriMatcher can match the URI to a spcific code
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                //For query "?" in the selection,we need to have an element in the selection
                //argument that will fill in the "?".Since we have 1 question mark in the selection
                ...
                break;
            default:
                throw new IllegalArgumentException("Cannot query database URI" + uri);
        }
