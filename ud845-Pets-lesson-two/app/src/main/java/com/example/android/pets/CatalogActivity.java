...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                //Create new Intent to go to to {@link EditorActivity.class};
                Intent intent = new Intent(CatalogActivity.this,EditorActivity.class);
                ...
                //Launch to display the data for current pet
                startActivity(intent);
            }
        });
    ...
    /*###private void displayDatabaseInfo() {
        ...
        //to get a cursor tat contains all rows from the pets table
        //Cursor cursor=db.rawQuery("SELECT * FROM " + PetContract.PetEntry.TABLE_NAME,null);
        // Rather db.query is better than it is quite structured and quite free from error.
        String[] projection={
        ...
        /*##try {
            //Display the numbr of rows in the Cursor(Which reflects the number of rows in the
